...
{!! Form::email('email', $delivery_details->email, ['id'=>'email', 'class' => '','required', 'placeholder' => 'Email Address']) !!}

<input type="hidden" name="user_id" value="{{$delivery_details->user_id}}">

{!! Form::text('first_name', $delivery_details->first_name, ['id'=>'first_name', 'class' => 'input-left','required', 'placeholder' => 'First Name']) !!}
...
{!! Form::text('last_name', $delivery_details->last_name, ['id'=>'last_name', 'class' => 'input-left','required', 'placeholder' => 'Last Name']) !!}
...
{!! Form::text('telephone', $delivery_details->telephone, ['id'=>'telephone', 'class' => 'input-left','required', 'placeholder' => 'Telephone']) !!}
...
{!! Form::textarea('address', $delivery_details->address, ['id'=>'address', 'class' => '', 'cols'=>'15' , 'rows'=>'5','required']) !!}
