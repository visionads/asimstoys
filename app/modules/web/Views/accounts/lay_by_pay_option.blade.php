                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="col-md-12" id="e-way-button">
                                ...
                                <input type="text" name="amount" id="edValue" value="50.00" class="form-control" placeholder="50.00 or more " required onKeyPress="edValueKeyPress()" onKeyUp="edValueKeyPress()"><br>
                                ...
                                <div style="padding: 20%; text-align: center">
                                    ...
                                    <script>
                                        function edValueKeyPress() {
                                            var x_value = document.getElementById("edValue").value;
                                        }
                                    </script>
                                    <script src="https://secure.ewaypayments.com/scripts/eCrypt.js"
                                            ...
                                            data-allowedit="true"
                                            data-resulturl="http://localhost/~selimreza/asimstoys/public/details_of_lay_by/"+{{$order_data->id}}
                                    >
                                    </script>
                                </div>
