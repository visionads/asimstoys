...
@section('content')
        <h1 style="color: white; background: yellow; padding: 10px;">Apologies for inconvenience ! We are still fixing our technical issues. Please call us if occurs anything! </h1>
