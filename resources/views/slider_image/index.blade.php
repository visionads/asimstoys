                            ...
                            @foreach($data as $values)
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        @if($values->image != '')
                                            <div>
                                                <a href="{{ route('slider_image.image.show', $values->slug) }}" class="btn btn-info btn-xs" data-toggle="modal" data-target="#imageView"><img src="{{ URL::to($values->image) }}" height="50px" width="50px" alt="{{$values->image}}" />
                                                </a>
                                            </div>
                                        @endif
                                    </td>
