...
<div class="row">
    <div class="col-lg-12">
        <section class="panel">
            ...
            {!! Form::open(['route' => 'user-signup.store-signup','files'=>'true']) !!}
            ...
            <div class="panel-body">
                <div class="adv-table">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::email('email', Input::old('email'), ['id'=>'email', 'class' => 'form-control', 'required'=>'required']) !!}
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::file('image', Input::old('image'),array('class' => 'form-control','placeholder'=>'')) !!}
                    </div>
