        ...
        <div class="col-lg-12">
            <section class="panel">
                ...
                <header class="panel-heading">
                    Zip Pay Order History </br>
                    <i> all pre order history</i>
                </header>
                            ...
                            @if(isset($data))
                                @foreach($data as $values)
                                    <tr class="gradeX">
										...
										<td>
											<a href="{{ route('order-shipped', $values->id) }}" class="btn btn-success btn-xs" onclick="return confirm('Are you sure to Delivered as Complete ?')" title="Delivered the Order as Completed">Delivered</a>
										</td>
										<td>
											<a href="{{ route('order-archive', $values->id) }}" class="btn btn-success btn-xs" onclick="return confirm('Are you sure to Archive this order ?')" title="Archive this Order">Archive</a>
										</td>
                                    </tr>
                            @endforeach
                            @endif
